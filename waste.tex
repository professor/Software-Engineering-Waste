...
\usepackage{balance} % balance bibliography on last page with a \balance at end




% \usepackage[none]{hyphenat} % turn off hyphenation for grammarly checking
...
\title{Software Development Waste}
